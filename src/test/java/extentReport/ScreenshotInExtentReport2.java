...
public class ScreenshotInExtentReport2 {
    
	@Test
	public void TakesScreenshotmethod() throws IOException, InterruptedException {
	      
		 ExtentReports extentReport=new ExtentReports();
		 ExtentSparkReporter sparkReporter=new ExtentSparkReporter("D:\\Khushboo\\Java\\javaeclipse\\Custom\\TestExtentReport\\report3.html");
		 extentReport.attachReporter(sparkReporter);
		
		 ExtentTest Test=extentReport.createTest("Screenshot test");
